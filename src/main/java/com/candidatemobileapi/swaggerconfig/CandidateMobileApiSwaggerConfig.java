...
public class CandidateMobileApiSwaggerConfig {
	...
	private ApiInfo metaData() {
		ApiInfo apiInfo = new ApiInfo(
				CandidateMobileApiConstants.CANDIDATES_MOBILE_API,CandidateMobileApiConstants.APP_VERSION,
				CandidateMobileApiConstants.APP_DESC, "", new Contact("","",""), CandidateMobileApiConstants.APP_HOST, CandidateMobileApiConstants.BASE_PATH);
		return apiInfo;
	}
